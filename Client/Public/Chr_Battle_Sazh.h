...
public:
	...
	enum ANIMATION_CHR_BATTLE_SAZH {	// FINISH -> ÀüÅõ Á¾·á	// IDLE_IDLEÀº STATE¶û °ãÃ³¼­ ¸¸µë
		...
		MOVE_BACK_END, MOVE_BACK_IDLE, MOVE_BACK_START,
		MOVE_LEFT_END_LEFT, MOVE_LEFT_END_RIGHT, MOVE_LEFT_IDLE, MOVE_LEFT_START,
		MOVE_RIGHT_END, MOVE_RIGHT_IDLE, MOVE_RIGHT_START,
		MOVE_STRAIGHT_END, MOVE_STRAIGHT_IDLE, MOVE_STRAIGHT_START,
		OPTIMACHANGE_FIRST, OPTIMACHANGE_SECOND,
		SKILL_NOR1, SKILL_NOR2, TURN_LEFT, TURN_RIGHT, ANIMATION_END
	};
