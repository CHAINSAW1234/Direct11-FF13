...
{
public:
	enum TURN { TURN_X, TURN_Y, TURN_Z, TURN_NONE };
...
public:
	...
	_float3 Get_LerpScale() { return m_vLerpScale; }
	...
	void Set_LerpScale(_float3 vLerfScale) { m_vLerpScale = vLerfScale; }
public:
	void Reset_Effect();
...
protected:
	...
	_float3			m_vLerpScale = { 1.f,1.f,1.f };									// Lerf가 들어갈때 변화될 스케일 값 
