...
HRESULT CMainApp::Initialize()
{
	...
	if (FAILED(Ready_Component_For_Loading()))
		return E_FAIL;
...
HRESULT CMainApp::Ready_Component_For_Loading()
{

	/* For.Prototype_GameObject_LoadingBlur */
	if (FAILED(m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_LoadingBlur"),
		CLoadingBlur::Create(m_pDevice, m_pContext))))
		return E_FAIL;
