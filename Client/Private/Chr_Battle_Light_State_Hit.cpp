...
CChr_Battle_Light_State_Hit::CChr_Battle_Light_State_Hit(CChr_Battle_Light* pChr_Battle_Light)
{
	m_pChr_Battle_Light = pChr_Battle_Light;
}

void CChr_Battle_Light_State_Hit::OnStateEnter()
{
...
void CChr_Battle_Light_State_Hit::OnStateUpdate(_float fTimeDelta)
{
	switch (m_eState) {
	case GROUND:
...
void CChr_Battle_Light_State_Hit::OnStateExit()
{
}

void CChr_Battle_Light_State_Hit::Hit_Ground(_float fTimeDelta)
{
...
void CChr_Battle_Light_State_Hit::Hit_Air(_float fTimeDelta)
{
	if (m_pChr_Battle_Light->Is_Animation_Finished()) {
...
CChr_Battle_Light_State_Hit* CChr_Battle_Light_State_Hit::Create(CChr_Battle_Light* pChr_Battle_Light)
{
	CChr_Battle_Light_State_Hit* pInstance = new CChr_Battle_Light_State_Hit(pChr_Battle_Light);

	return pInstance;
}

void CChr_Battle_Light_State_Hit::Free()
{
	__super::Free();
}
